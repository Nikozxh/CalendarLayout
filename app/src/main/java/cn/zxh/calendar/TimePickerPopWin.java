...
public class TimePickerPopWin extends PopupWindow implements View.OnClickListener {
    ...
    private DatePickerPopWin.OnDateScrollListener mOnDateScrollListener;
    ...
    private void initView(){
        ...
        hourLoopView.setLoopListener(new LoopScrollListener() {
            ...
            public void onItemSelect(int item) {
                hourPos=item;
                if(mOnDateScrollListener!=null){
                    Date selectedNow = getNowPosDate();
                    mOnDateScrollListener.onDateScrollListener(selectedNow);
                    mSelectedDate = selectedNow;
                }
            }
        });
    ...
    public interface OnDateScrollListener{
        void onDateScrollListener(Date date);
    }
    /**
     * 设置日期滚动事件
     * */
    public void setDateScrollListener(DatePickerPopWin.OnDateScrollListener onDateScrollListener){
        mOnDateScrollListener = onDateScrollListener;
    }

    private Date getNowPosDate(){
        int hour = hourPos;
